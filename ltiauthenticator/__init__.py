...
class LTIAuthenticateHandler(BaseHandler):
    ...
    that URL after authentication. Else, will send them to server or /home
    according to JupyterHub configuration.
    ...
    def post(self):
        ...
        default_next_url = self.get_next_url(user)
        next_url = self.get_body_argument(
            name='custom_next',
